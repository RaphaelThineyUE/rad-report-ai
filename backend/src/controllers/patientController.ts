...
export async function createPatient(req: AuthRequest, res: Response): Promise<void> {
  ...
  logPatientAudit(req.userId, 'create_patient', data.id, req.accessToken, String(req.ip ?? ''));
...
export async function updatePatient(req: AuthRequest, res: Response): Promise<void> {
  ...
  logPatientAudit(req.userId, 'update_patient', id, req.accessToken, String(req.ip ?? ''));
  res.json(data);
}
...
export async function deletePatient(req: AuthRequest, res: Response): Promise<void> {
  ...
  logPatientAudit(req.userId, 'delete_patient', id, req.accessToken, String(req.ip ?? ''));
  res.status(204).send();
}
