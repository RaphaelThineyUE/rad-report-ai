...
export async function createReport(req: AuthRequest, res: Response): Promise<void> {
  ...
  logReportAudit(req.userId, 'create_report', data.id, req.accessToken, String(req.ip ?? ''));
...
export async function updateReport(req: AuthRequest, res: Response): Promise<void> {
  ...
  logReportAudit(req.userId, 'update_report', id, req.accessToken, String(req.ip ?? ''));
  res.json(data);
}
...
export async function deleteReport(req: AuthRequest, res: Response): Promise<void> {
  ...
  logReportAudit(req.userId, 'delete_report', id, req.accessToken, String(req.ip ?? ''));
  res.status(204).send();
}
